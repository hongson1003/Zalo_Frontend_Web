...
const TrackSound = ({ soundTrack, fetchInfoUser }) => {
    ...
    return (
        <div className="track-ultils">
            <audio onEnded={() => setIsPlaying(false)} ref={audioRef} hidden controls src="https://res.cloudinary.com/hongsonit10/raw/upload/v1714408702/zalo/nangchentieusa_chungtacuasaunay-1714408698225.mp3"></audio>
