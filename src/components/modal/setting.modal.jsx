    ...
    return (
        <div className='privacy'>
            ...
            <div className='add-email'>
                {
                    !status ? <Button type='default' onClick={handleAddEmail}>Thêm email</Button> : (
                        status === STATE.READY ?
                            <>
                                <Input
                                    value={text}
                                ...
                                status === STATE.PENDING ?
                                    ...
                                    <>
                                        <Input value={email} />
                                        <Button type='default' onClick={handleChangeEmail}>Thay đổi</Button>
                                    </>
                            )
                    )
                }
            ...
            <div className='session'>
                ...
                <div className='options'>
                    <div className='item'>
                        ...
                        <Switch defaultChecked onChange={() => onChange(SETTING.SHOW_DATE)} />
                    </div>
                    <div className='item'>
                        <p className='name'>Nhóm chung</p>
                        <Switch defaultChecked onChange={() => onChange(SETTING.SHOW_STATUS_ONLINE)} />
                    </div>
                    <div className='item'>
