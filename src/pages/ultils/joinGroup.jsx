    ...
    const handleJoinGroup = async () => {
        try {
            ...
            if (res.errCode === 0) {
                ...
                await sendNotifyToChatRealTime(id, `${user.userName} đã tham gia nhóm từ đường link`, MESSAGES.NOTIFY);
                socket.then(socket => {
        ...
        <div className="join-group-container">
            <div className="content-body">
                ...
                <div className="group-info">
                    ...
                    <Button type="primary" onClick={handleJoinGroup} loading={isLoading}>Tham gia nhóm</Button>
                </div>
            </div>
        </div>
    )
