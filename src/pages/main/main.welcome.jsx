...
const pages = [
    {
        ...
        title: "Sử dụng tin nhắn nhanh để lưu trữ sẵn các tin nhắn thường dùng và gửi nhanh trong hội thoại bất kì"
    },
    {
        img: "/images/welcome2.PNG",
        title: "Bây giờ tin nhắn đã có thể tự động xóa sau khoảng thời gian nhất định"
    },
    {
    ...
    },
    {
        ...
        title: "Giờ đây bạn có thể dễ dàng xuất dữ liệu và nhập dữ liệu của mình khi đổi máy tính mới"
    },
    {
        img: "/images/welcome6.PNG",
        title: "Kết nối và giải quyết công việc trên mọi thiết bị với dữ liệu luôn được đồng bộ"
    },
    {
